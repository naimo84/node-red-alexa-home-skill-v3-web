...
Introduction
**********
With 4500+ users, and 14000+ defined devices, available in 12 Amazon Alexa markets, English and German locales for Google Assistant (other markets/ locales to follow), Node-RED Smart Home Control enables you to quickly bring voice-control to your Node-RED flows, using Amazon Alexa and/ or Google Assistant.
