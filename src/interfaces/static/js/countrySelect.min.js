!(function (n) {
  ...
  (p.prototype = {
    ...
    _generateMarkup: function () {
      ...
      var t = n('<div>', { class: 'flag-dropdown' }).insertAfter(
          this.countryInput
        ),
    ...
    _appendListItems: function (i, t) {
      ...
      n.each(i, function (n, i) {
        (a +=
          '<li class="country ' + t + '" data-country-code="' + i.iso2 + '">'),
    ...
    _loadAutoCountry: function () {
      n.fn[e].autoCountry
        ...
        : n.fn[e].startedLoadingAutoCountry ||
          ((n.fn[e].startedLoadingAutoCountry = !0),
    ...
    _handleLetterKey: function (i) {
      var t = String.fromCharCode(i),
        a = this.countryListItems.filter(function () {
          return (
            n(this).text().charAt(0) == t && !n(this).hasClass('preferred')
          );
        });
      if (a.length) {
        var e,
        ...
        (e =
          s && s.next() && s.next().text().charAt(0) == t
            ? s.next()
            : a.first()),
    ...
    _getCountryData: function (n, i) {
      for (var t = i ? y : this.countries, a = 0; a < t.length; a++)
    ...
    handleAutoCountry: function () {
      'auto' === this.options.initialCountry &&
        ((this.defaultCountry = n.fn[e].autoCountry),
    ...
    (n.fn[e] = function (i) {
      ...
      if (i === a || 'object' == typeof i)
        return this.each(function () {
          n.data(this, 'plugin_' + e) ||
            n.data(this, 'plugin_' + e, new p(this, i));
        });
      if ('string' == typeof i && '_' !== i[0] && 'init' !== i) {
        ...
        return (
          this.each(function () {
            ...
            a instanceof p &&
              'function' == typeof a[i] &&
              (s = a[i].apply(a, Array.prototype.slice.call(t, 1))),
  ...
  var y = n.each(
    [
      ...
      { n: 'Åland Islands (Åland)', i: 'ax' },
      { n: 'Albania (Shqipëri)', i: 'al' },
      ...
      { n: 'Central African Republic (République Centrafricaine)', i: 'cf' },
      { n: 'Chad (Tchad)', i: 'td' },
      { n: 'Chile', i: 'cl' },
      { n: 'China (中国)', i: 'cn' },
      ...
      { n: 'Czech Republic (Česká republika)', i: 'cz' },
      { n: 'Denmark (Danmark)', i: 'dk' },
      { n: 'Djibouti', i: 'dj' },
      { n: 'Dominica', i: 'dm' },
      { n: 'Dominican Republic (República Dominicana)', i: 'do' },
      { n: 'Ecuador', i: 'ec' },
      { n: 'Egypt (‫مصر‬‎)', i: 'eg' },
      { n: 'El Salvador', i: 'sv' },
      ...
      { n: 'Faroe Islands (Føroyar)', i: 'fo' },
      { n: 'Fiji', i: 'fj' },
      { n: 'Finland (Suomi)', i: 'fi' },
      { n: 'France', i: 'fr' },
      { n: 'French Guiana (Guyane française)', i: 'gf' },
      { n: 'French Polynesia (Polynésie française)', i: 'pf' },
      { n: 'Gabon', i: 'ga' },
      { n: 'Gambia', i: 'gm' },
      ...
      { n: 'Guatemala', i: 'gt' },
      { n: 'Guernsey', i: 'gg' },
      { n: 'Guinea (Guinée)', i: 'gn' },
      { n: 'Guinea-Bissau (Guiné Bissau)', i: 'gw' },
      { n: 'Guyana', i: 'gy' },
      { n: 'Haiti', i: 'ht' },
      { n: 'Honduras', i: 'hn' },
      { n: 'Hong Kong (香港)', i: 'hk' },
      { n: 'Hungary (Magyarország)', i: 'hu' },
      { n: 'Iceland (Ísland)', i: 'is' },
      { n: 'India (भारत)', i: 'in' },
      { n: 'Indonesia', i: 'id' },
      { n: 'Iran (‫ایران‬‎)', i: 'ir' },
      { n: 'Iraq (‫العراق‬‎)', i: 'iq' },
      ...
      { n: 'Mozambique (Moçambique)', i: 'mz' },
      { n: 'Myanmar (Burma) (မြန်မာ)', i: 'mm' },
      { n: 'Namibia (Namibië)', i: 'na' },
      { n: 'Nauru', i: 'nr' },
      { n: 'Nepal (नेपाल)', i: 'np' },
      { n: 'Netherlands (Nederland)', i: 'nl' },
      { n: 'New Caledonia (Nouvelle-Calédonie)', i: 'nc' },
      { n: 'New Zealand', i: 'nz' },
      { n: 'Nicaragua', i: 'ni' },
      { n: 'Niger (Nijar)', i: 'ne' },
      { n: 'Nigeria', i: 'ng' },
      ...
      { n: 'Puerto Rico', i: 'pr' },
      { n: 'Qatar (‫قطر‬‎)', i: 'qa' },
      { n: 'Réunion (La Réunion)', i: 're' },
      { n: 'Romania (România)', i: 'ro' },
      { n: 'Russia (Россия)', i: 'ru' },
      { n: 'Rwanda', i: 'rw' },
      { n: 'Saint Barthélemy (Saint-Barthélemy)', i: 'bl' },
      { n: 'Saint Helena', i: 'sh' },
      { n: 'Saint Kitts and Nevis', i: 'kn' },
      { n: 'Saint Lucia', i: 'lc' },
      { n: 'Saint Martin (Saint-Martin (partie française))', i: 'mf' },
      { n: 'Saint Pierre and Miquelon (Saint-Pierre-et-Miquelon)', i: 'pm' },
      { n: 'Saint Vincent and the Grenadines', i: 'vc' },
      { n: 'Samoa', i: 'ws' },
      { n: 'San Marino', i: 'sm' },
      { n: 'São Tomé and Príncipe (São Tomé e Príncipe)', i: 'st' },
      { n: 'Saudi Arabia (‫المملكة العربية السعودية‬‎)', i: 'sa' },
      { n: 'Senegal (Sénégal)', i: 'sn' },
