...
table:
   ...
   |             |             |             |             | 50%"        |
   +-------------+-------------+-------------+-------------+-------------+
   | Channel     | E           | Channel     | HTTP Out    | "Alexa, set |
   | Control     | xperimental | number or   | node        | Lounge TV   |
   |             | (number     | name etc.   |             | channel to  |
   |             | only)       |             |             | (101 \|     |
   |             |             |             |             | BBC1)",     |
   |             |             |             |             | "Hey        |
   |             |             |             |             | Google, set |
   ...
   |             |             |             |             | etc)"       |
   +-------------+-------------+-------------+-------------+-------------+
   | Color       | C           | Warm, Warm  | M           | "Alexa, set |
   | Temperature | olorSetting | White,      | QTT-enabled | Lounge      |
   ...
   |             |             | White       |             |             |
   +-------------+-------------+-------------+-------------+-------------+
   | Contact     | Co          | \*No        | N/A         | "Alexa, is  |
   | Sensor      | ntactSensor | commands\*  |             | the Kitchen |
   |             |             |             |             | window      |
   |             |             |             |             | open?" Note |
   |             |             |             |             | you can     |
   |             |             |             |             | also use    |
   ...
   |             |             |             |             | Lounge?"    |
   +-------------+-------------+-------------+-------------+-------------+
   | Thermostat  | TemperatureSetting | Auto, Eco,  | Any         | "Alexa, set |
   | Control     |             | Heat, Cool, | Thermostat  | Thermostat  |
